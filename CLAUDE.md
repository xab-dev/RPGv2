...
**En attente d'une décision de Xav, à ne pas commencer** : `Q-07` (gelée) ; le défilement incrémental du calque statique (`D-01`, le seul remède qui baisserait le pic). Les captures de la V1 (`docs/captures/v1/`) sont une **inspiration, jamais un cahier des charges** : aucun ticket ne les lit tant que `E-03` n'est pas rempli. **Une spec non écrite ne se commence pas.**
