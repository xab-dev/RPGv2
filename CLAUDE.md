...
- **Branches ouvertes** : aucune (`ouverture-capuche` fusionnée dans `main` et publiée). À reprendre : `D-261` (le polish de profil). Pour la suite, Xav : les animations du héros.
