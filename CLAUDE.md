...
- **Branches ouvertes** : aucune. Prêt sur `main`, **non poussé** : les proportions du héros harmonisées et l'œil dans son ouverture de côté (`D-258`, `D-259`, `V-179`, `V-180` à voir) et le journal de la session. À reprendre : `D-260` (la tangente de l'ouverture de côté). Pour la suite, Xav : les animations du héros.
