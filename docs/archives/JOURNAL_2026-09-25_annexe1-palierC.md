...
- `Q-156`, le banc de la spec 13 à chaque palier : tranchée par Xav, « on garde sentinelle régulièrement, banc complet sur les gros patch + fin de journée (ou au réveil) tous les jours. rien si ce n'est que des données, pareil pour l'équilibrage, je pourrais retoucher directement dans data (déja fais sur les mobs de la nuit qui donnait trop à mon gout) » Règle amendée : banc complet sur les gros patchs et une fois par jour, sentinelle (`traversee_nuit` Moyen ×1 et ×6) pour le code joué à chaque frame, rien pour des données seules.
