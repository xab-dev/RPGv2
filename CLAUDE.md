...
## Journal de session — `D-50` : Échap court ferme le menu, Échap long quitte le plein écran (20/09)
...
**Reste dû : `V-32`** — Xav, au clavier, sous Chrome PC, le jeu passé en plein écran **par l'entrée de menu** : Échap court ferme le menu et le plein écran reste · Échap court le rouvre · Échap maintenu sort · hors plein écran, Échap comme avant. La mesure dit que le verrou part ; elle ne dit pas si l'appui maintenu tombe bien sous le doigt en jouant.
