...
- **Branches ouvertes** : aucune. Prêt sur `main`, **non poussé** : les proportions du héros harmonisées (`D-258`, `V-179` à voir) et le journal de la session. Pour la suite, Xav : les animations du héros.
