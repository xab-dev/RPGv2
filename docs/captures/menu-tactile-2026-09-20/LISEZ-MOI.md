...
| `d30_refus-sans-geste_703x280.jpg` | `D-30`. L'entrée « Plein écran » confirmée **sans geste utilisateur** — la situation exacte de la manette, lue par sondage et non par événement. Le navigateur refuse, le libellé **ne ment pas** (il reste « Plein écran »), et un message localisé le dit au joueur. |
