...
}
{
  ...
  const ligne = (etat) => formaterReleve({
    ...
    entites: { monstres: { dessines: 0, presents: 0 }, puzzles: { dessines: 0, presents: 0 }, objetsSol: { dessines: 0, presents: 0 }, lumieres: { dessines: 0, presents: 0 } },
    monstresMoyens: { dessines: 0, presents: 0 },
