...
| — | Publication | Fusion de `heros-animation` et de `reinit-exporter` dans `main` (commits de fusion), suite verte (234 fichiers), `v0.9.0` (x incrémenté, à la demande de Xav), tag et release « Le héros » |
