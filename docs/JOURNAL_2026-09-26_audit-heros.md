...
| `(ce commit)` | D-290 | L'ouverture cède la place au contour gris (`efface`, variante C : ~333° → ~322°). La cause : l'ouverture ne s'éteignait qu'à la clé cachée et recouvrait le liseré. À voir : `V-201` |
