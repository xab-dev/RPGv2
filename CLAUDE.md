...
- **Branche ouverte : `audit-heros`** (fusionnée dans `main` à `v0.9.28`, 26/09) — spec 17, l'audit du héros : A, B et C livrés (C : `D-286` à `D-294`, dont les proportions et les traits fins ; glow, particules et agrafe restent des pistes), reste D, l'état des lieux en captures. À reprendre : `D-272` (P1, avant d'agrandir le catalogue).
