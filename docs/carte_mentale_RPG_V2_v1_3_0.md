...
**Version : 1.3.0** — **cadrage clos. Roadmap rédigée : `specs/00_ROADMAP.md`. Phases 0 et 1 livrées et validées ; Phase 2 spécifiée dans `specs/03_maison-exterieur.md`.**
