...
- **Branches ouvertes** : `ouverture-capuche` (depuis `main`, non fusionnée) : `D-260` livré (l'ouverture de côté découpée par la capuche, avancée de profil ; `V-181` à voir). À reprendre : `D-261` (le polish de profil). Sur `main`, **non poussés** : `D-258`, `D-259` (`V-179`, `V-180` à voir). Pour la suite, Xav : les animations du héros.
