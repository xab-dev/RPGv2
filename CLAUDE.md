...
5. **La nuit du 20/09** (file autonome n° 2, `BRIEF_nuit-2026-09-20.md`) : la double orbite du follet (`D-39`), le retrait des noms de monstres (`D-40`), puis `D-17` (bouton MENU tactile sous le bandeau), `D-13` (buffs au bandeau) et `D-30` (plein écran au premier appui tactile).
...
## Journal de session — Nuit du 20/09 (file autonome n° 2)

`BRIEF_nuit-2026-09-20.md` v1.2.0. Branche **`nuit-2026-09-20`**, créée depuis `main` (la nuit du 19 y est
fusionnée, la lumière du follet `D-35` y est **annulée** — `git revert 9997cec`, décision de Xav) ; **aucun `push`**.

**Le journal de bord de cette nuit vit sur le disque, pas ici : `docs/JOURNAL_2026-09-20.md`.** Une ligne par
commit, écrite au moment du commit — c'est lui qui devient le rapport du matin (règle d'hygiène de contexte du
§0 bis du brief : ce qui n'est dit que dans la conversation se perd quand elle se résume).
