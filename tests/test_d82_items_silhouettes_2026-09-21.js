...
const REFONDUS = ['visuel_plume', 'visuel_branche', 'visuel_caillou', 'visuel_pierre', 'visuel_bois', 'visuel_fruit', 'visuel_fruit_cuit', 'visuel_hache', 'visuel_pioche', 'visuel_icone_epee_bois'];
