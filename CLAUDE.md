...
- **Dernière publication : `v0.8.74`** (26/09, `main` et les tags `v0.8.66`, `v0.8.74` poussés ; dernière release : `v0.8.0`). Depuis `v0.8.0` : épilepsie (`D-220`, `D-221`), profondeur (`D-222` à `D-224`), polish libre, `npm run dettes`, orientation et visée (`D-229`, `D-247` à `D-249`), triche `?cheat=phenom` (`D-250`), dettes `D-243`, `D-244`, `D-246` (`V-171` à `V-173` à voir), le ménage du contexte (`DOC-10`), le joystick en laisse et bornée (`D-138`, `D-251`, `Q-178`, `Q-179`), et le héros redessiné (`D-252` à `D-257` : la capuche pliée sur l'axe dans les huit vues, l'œil en globe au fond de sa capuche ; `V-176` validé à l'oral, `V-177`, `V-178` à voir).
- **Branches ouvertes** : `ouverture-capuche` (depuis `main`) : `D-260`, l'ouverture de la capuche de côté déformée en perspective, une vue à la fois (`sud_ouest` d'abord : le bas arrière se creuse entre deux bornes fixes ; ensuite, le coin opposé). Prêt sur `main`, **non poussé** : `D-258`, `D-259` (`V-179`, `V-180` à voir). Pour la suite, Xav : les animations du héros.
