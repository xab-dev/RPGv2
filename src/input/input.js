...
// `target_next` (`D-54`) : cible suivante pour le follet. Au doigt, c'est
// toucher le follet (`Q-40`, 23/09 — une zone qui suit le monde, cf.
// touch.js#zonesMonde). Un verbe qu'une source ignore vaut simplement
// `false` pour elle, la fusion ci-dessous n'a pas de cas particulier à écrire.
