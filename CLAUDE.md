...
5. ~~**La nuit du 20/09** (file autonome n° 2)~~ — **les cinq tickets sont livrés et fusionnés** (`D-39`, `D-40`, `D-17`, `D-13`, `D-30`). Le playtest téléphone qui a suivi en a rouvert deux : **`D-42`** (menu non fermable au tactile, P1) et **`D-30`** (le plein écran ne part jamais) — c'est la mini-file `BRIEF_menu-tactile_2026-09-20.md`, trois commits, qui les prend.
